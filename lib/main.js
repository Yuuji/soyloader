function soyloader(templateDir, soyFile) {
    ...
    var rebuildSoyFile = function() {
        ...
        console.log('Rebuilding soy file');
        ...
        console.log('Rebuilding soy file done');
    ...
    var buildSoyQueueProcess = function() {
        if (buildSoyInProgressLast!= buildSoyQueue.length) {
            console.log('buildSoyQueue: ' + buildSoyQueue.length);
    ...
    var buildSoyIntern = function(file) {
        ...
        exec('/usr/bin/java -jar ./libs/SoyToJsSrcCompiler.jar --codeStyle ' + type + ' --outputPathFormat ' + tempName + ' ' + templateDir + file, function (error, stdout, stderr) {
            buildSoyInProgress--;
            setTimeout(buildSoyQueueProcess, 100);
            if (error !== null) {
            ...
            if (fs.existsSync(tempName)) {
                ...
                console.log('Template not build');
            }
